 ...
 * @author jGauravGupta
 */
public class BeanModelTest extends BaseModelTest {

    @BeforeAll
    static void setup() {
        GenerateSettings.setFluentAPIEnabled(true);
    }
    
    @Test
    void testGenerator() throws Exception {
        testModelerFile("BeanModel.jpa");
    }
    ...
    @AfterAll
    static void tear() {
        GenerateSettings.setFluentAPIEnabled(false);
    }
