 ...
 * @author jGauravGupta
 */
public class OrderByModelTest extends BaseModelTest {

    // TODO : Default support in OrderBy UI, @OrderBy("lastname") => @OrderBy("lastname ASC")

    @Test
    void testGenerator() throws Exception {
        testModelerFile("OrderByModel.jpa");
    }
