...
public interface RuntimeProvider {
    ...
    void updatePersistenceProvider(DatabaseType databaseType);

    void addDependency(boolean docker);

    void addTestDependency(boolean docker);
    ...
    default Runtime getRuntime() {
        return this.getClass().getAnnotation(Runtime.class);
    }
}
