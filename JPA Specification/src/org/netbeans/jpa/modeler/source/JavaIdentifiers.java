 ...
 * the License.
 */
package org.netbeans.jpa.modeler.source;
...
/**
 * This class consists of static utility methods for working with Java
 * identifiers.
 */
public final class JavaIdentifiers {
    ...
    /**
     * Checks whether the given <code>packageName</code> represents a valid name
     * for a package.
     *
    ...
    /**
     * Gets the fully qualified name for the given <code>fileObject</code>. If
     * it represents a java package, returns the name of the package (with dots
     * as separators).
     *
     * @param fileObject the file object whose FQN is to be get; must not be
     * null.
     ...
     * @throws IllegalArgumentException if the given <code>fqn</code> was not a
     ...
     *
     * @param fqn the fully qualified class name. Must not be null or empty and
     * must represent a valid fully qualified name.
