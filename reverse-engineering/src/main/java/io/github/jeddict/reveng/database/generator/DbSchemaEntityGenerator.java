...
/**
 * This class provides an algorithm to produce a set of entity beans and relations
 * from a dbschema element.
 *
 * @author Chris Webster, Martin Adamek, Andrei Badea
 */
public class DbSchemaEntityGenerator {
    ...
    private final static Logger LOGGER = Logger.getLogger(DbSchemaEntityGenerator.class.getName());
     ...
     * for.
     */
    public DbSchemaEntityGenerator(GeneratedTables genTables, SchemaElement schemaElement) {
     ...
     */
    public DbSchemaEntityGenerator(GeneratedTables genTables, SchemaElement schemaElement, CollectionType collectionType, boolean useColumnNamesInRelationships, boolean useDefaults, boolean generateUnresolvedRelationships) {
    ...
    /**
     * Returns true if the table is a join table. A table is considered a join
     * table regardless of whether the tables it joins are included in the
     * tables to generate.
     */
...
//        #188550 add backward compartible option to have column names instead of tables names
    ...
    /**
     * consider equal if refernced from/to the same tables with the same set of
     * columns, fk name do not matter
     */
