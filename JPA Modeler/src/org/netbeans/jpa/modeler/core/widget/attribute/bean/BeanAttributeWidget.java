 ...
 * the License.
 */
package org.netbeans.jpa.modeler.core.widget.attribute.bean;
 ...
 * @author Gaurav Gupta
 */
public class BeanAttributeWidget extends AttributeWidget<BeanAttribute> {

    public BeanAttributeWidget(JPAModelerScene scene, IPNodeWidget nodeWidget, PinWidgetInfo pinWidgetInfo) {
