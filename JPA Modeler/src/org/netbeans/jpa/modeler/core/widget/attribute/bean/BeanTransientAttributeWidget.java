 ...
 * @author Gaurav Gupta
 */
public class BeanTransientAttributeWidget extends AttributeWidget<Transient> {

    public BeanTransientAttributeWidget(JPAModelerScene scene, IPNodeWidget nodeWidget, PinWidgetInfo pinWidgetInfo) {
