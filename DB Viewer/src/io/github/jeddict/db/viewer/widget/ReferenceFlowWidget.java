...
import org.netbeans.jpa.modeler.widget.flow.AbstractEdgeWidget;
 ...
 * @author Gaurav_Gupta
 */
public class ReferenceFlowWidget extends AbstractEdgeWidget<DBViewerScene> {
    ...
    public ReferenceFlowWidget(DBViewerScene scene, EdgeWidgetInfo edge) {
        super(scene, edge);
    }
