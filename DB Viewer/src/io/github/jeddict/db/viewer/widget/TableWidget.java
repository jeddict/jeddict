...
import org.netbeans.jpa.modeler.widget.FlowNodeWidget;
import io.github.jeddict.db.viewer.ddl.RenameTableDDL;
...
import io.github.jeddict.db.viewer.spec.DBSchema;
...
import org.netbeans.db.modeler.widget.api.IPrimaryKeyWidget;
import static org.netbeans.db.modeler.initializer.DBModelerUtil.BASE_TABLE;
import static org.netbeans.db.modeler.initializer.DBModelerUtil.BASE_TABLE_ICON_PATH;

import static org.netbeans.jpa.modeler.rules.entity.ClassValidator.CLASS_TABLE_NAME_WITH_RESERVED_SQL_KEYWORD;
import static org.netbeans.jpa.modeler.rules.entity.ClassValidator.NON_UNIQUE_TABLE_NAME;
...
public class TableWidget extends FlowNodeWidget<DBTable, DBViewerScene> {
    ...
    public TableWidget(DBViewerScene scene, NodeWidgetInfo node) {
        super(scene, node);
