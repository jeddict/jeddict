 ...
 * the License.
 */
package io.github.jeddict.db.viewer.action;

import io.github.jeddict.db.viewer.initializer.DBViewerActionListener;
...
public class DBViewerAction extends NodeAction {
    ...
    public void performAction(Node[] activatedNodes) {
        ...
        SwingUtilities.invokeLater(() -> {
            DBViewerActionListener actionListener = new DBViewerActionListener();
    ...
    private static void refresh(BaseNode baseNode) {
        RP.post(() -> {
            ...
            if (model != null) {
                try {
                    model.runReadAction(Metadata::refresh);
