...
import io.github.jeddict.db.viewer.spec.DBPrimaryKey;
import io.github.jeddict.db.viewer.spec.DBSchema;
import io.github.jeddict.db.viewer.spec.DBTable;
import java.awt.Rectangle;
import java.util.List;
import java.util.Map;
import io.github.jeddict.db.viewer.widget.ColumnWidget;
import io.github.jeddict.db.viewer.widget.ForeignKeyWidget;
import io.github.jeddict.db.viewer.widget.ReferenceFlowWidget;
import java.awt.Point;
import java.util.ArrayList;
import java.util.Collection;
import java.util.HashMap;
import io.github.jeddict.db.viewer.widget.TableWidget;
import org.netbeans.db.modeler.initializer.DBModelerUtil;
...
public class DBViewerUtil implements IModelerUtil<DBViewerScene> {

    @Override
    public void init() {
        DBModelerUtil dbModelerUtil = new DBModelerUtil();//use icon from DBModelerUtil
        dbModelerUtil.init();
    }

    @Override
    public void loadModelerFile(ModelerFile file) throws ProcessInterruptedException {
        DBViewerScene scene = (DBViewerScene) file.getModelerScene();
      ...
      private void loadTable(DBViewerScene scene, IFlowNode flowElement) {
...
//                    tableWidget.sortAttributes();
    ...
    private void loadFlowEdge(DBViewerScene scene) {
      ...
      private void loadEdge(DBViewerScene scene, TableWidget sourceTableWidget, ForeignKeyWidget foreignKeyWidget) {
//       ForeignKey => Source
//       PrimaryKey => Target
