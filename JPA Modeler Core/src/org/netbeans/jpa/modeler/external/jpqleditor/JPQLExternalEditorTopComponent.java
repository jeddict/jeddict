...
position = 1660)
public final class JPQLExternalEditorTopComponent extends TopComponent {

    /**
     * path to the icon used by the component and its open action
     */
    public static final String JPQL_ICON_PATH = "org/netbeans/modules/j2ee/persistence/jpqleditor/ui/resources/queryEditor16X16.png"; //NOI18N
    private static final Logger logger = Logger.getLogger(JPQLExternalEditorTopComponent.class.getName());
    ...
    private JPQLExternalEditorController controller = null;
    ...
    public static JPQLExternalEditorTopComponent getInstance() {
        return new JPQLExternalEditorTopComponent(null);
    }
    ...
    public JPQLExternalEditorTopComponent(JPQLExternalEditorController controller) {
        ...
        setName(NbBundle.getMessage(JPQLExternalEditorTopComponent.class, "CTL_JPQLExternalEditorTopComponent") + thisWindowCount);
        setToolTipText(NbBundle.getMessage(JPQLExternalEditorTopComponent.class, "HINT_JPQLExternalEditorTopComponent"));
        setIcon(ImageUtilities.loadImage(JPQL_ICON_PATH, true));
        ...
        showSQL(NbBundle.getMessage(JPQLExternalEditorTopComponent.class, "BuildHint"));
    }
    ...
    private class JPQLEditorPopupMouseAdapter extends PopupMouseAdapter {
        ...
        private final String RUN_JPQL_COMMAND = NbBundle.getMessage(JPQLExternalEditorTopComponent.class, "CTL_RUN_JPQL_COMMAND");
        private final String CUT_COMMAND = NbBundle.getMessage(JPQLExternalEditorTopComponent.class, "CTL_CUT_COMMAND");
        private final String COPY_COMMAND = NbBundle.getMessage(JPQLExternalEditorTopComponent.class, "CTL_COPY_COMMAND");
        private final String PASTE_COMMAND = NbBundle.getMessage(JPQLExternalEditorTopComponent.class, "CTL_PASTE_COMMAND");
        private final String SELECT_ALL_COMMAND = NbBundle.getMessage(JPQLExternalEditorTopComponent.class, "CTL_SELECT_ALL_COMMAND");
        ...
        public void run() {
            while (!isSqlTranslationProcessDone) {
                ...
                if (selectedConfigObject != null) {
                    ...
                    ph2 = ProgressHandleFactory.createHandle(NbBundle.getMessage(JPQLExternalEditorTopComponent.class, "progressTaskname"));
                    ph2.start(100);
                    ...
                    try {
                        ...
                        if(initialProblems.size()==0) {
                            ...
                            try {
                                ...
                                ph2.progress(50);
                                ph2.setDisplayName(NbBundle.getMessage(JPQLExternalEditorTopComponent.class, "queryParsingPassControlToProvider"));
                                jpqlResult = queryExecutor.execute(jpql, selectedConfigObject, pe, props, provider, 0, ph2, false);
                                ph2.progress(80);
                                ph2.setDisplayName(NbBundle.getMessage(JPQLExternalEditorTopComponent.class, "queryParsingProcessResults"));
    ...
    private void showSQLError(String errorResourceKey, String queryProblems) {
        if (queryProblems != null) {
            ...
            sqlEditorPane.setText(NbBundle.getMessage(JPQLExternalEditorTopComponent.class, errorResourceKey));
        }
        //
        switchToSQLView();
    }
    ...
    public void setResult(JPQLResult result, ClassLoader ccl) {
        ...
        if (result.getExceptions().isEmpty()) {
            ...
            strBuffer.append(NbBundle.getMessage(JPQLExternalEditorTopComponent.class, "queryUpdatedOrDeleted"));
            strBuffer.append(separator);

            strBuffer.append(space);
            strBuffer.append(result.getQueryResults().size());
            strBuffer.append(space);
            strBuffer.append(NbBundle.getMessage(JPQLExternalEditorTopComponent.class, "rowsSelected"));
            ...
            switchToErrorView();
            setStatus(NbBundle.getMessage(JPQLExternalEditorTopComponent.class, "queryExecutionError"));
        ...
        ph.progress(99);
        ph.setDisplayName(NbBundle.getMessage(JPQLExternalEditorTopComponent.class, "queryExecutionDone"));
    ...
    private void createTableHeaders(Vector<String> tableHeaders, Object oneObject) {
        if (oneObject == null || oneObject.getClass().getName().startsWith("java.lang") || oneObject.getClass().getName().startsWith("java.math")) {//NOI18N
            ...
            tableHeaders.add(org.openide.util.NbBundle.getMessage(JPQLExternalEditorTopComponent.class, "queryResultDefaultColumnName") + " " + (tableHeaders.size() + 1));//NOI18N
        } else {
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(sessionLabel, org.openide.util.NbBundle.getMessage(JPQLExternalEditorTopComponent.class, "JPQLExternalEditorTopComponent.sessionLabel.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(runJPQLButton, org.openide.util.NbBundle.getMessage(JPQLExternalEditorTopComponent.class, "JPQLExternalEditorTopComponent.runJPQLButton.text")); // NOI18N
        runJPQLButton.setToolTipText(org.openide.util.NbBundle.getMessage(JPQLExternalEditorTopComponent.class, "runJPQLQueryButtonToolTip")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(resultToggleButton, org.openide.util.NbBundle.getMessage(JPQLExternalEditorTopComponent.class, "JPQLExternalEditorTopComponent.resultToggleButton.text")); // NOI18N
        resultToggleButton.setToolTipText(org.openide.util.NbBundle.getMessage(JPQLExternalEditorTopComponent.class, "showResultTooltipText")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(sqlToggleButton, org.openide.util.NbBundle.getMessage(JPQLExternalEditorTopComponent.class, "JPQLExternalEditorTopComponent.sqlToggleButton.text")); // NOI18N
        sqlToggleButton.setToolTipText(org.openide.util.NbBundle.getMessage(JPQLExternalEditorTopComponent.class, "showSQLTooltipText")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(setMaxRowCountLabel, org.openide.util.NbBundle.getMessage(JPQLExternalEditorTopComponent.class, "JPQLExternalEditorTopComponent.setMaxRowCountLabel.text")); // NOI18N

        setMaxRowCountComboBox.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "100", "1000", "10000", "100000" }));
        setMaxRowCountComboBox.setToolTipText(org.openide.util.NbBundle.getMessage(JPQLExternalEditorTopComponent.class, "setMaxRowToolTip")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(statusLabel, org.openide.util.NbBundle.getMessage(JPQLExternalEditorTopComponent.class, "JPQLExternalEditorTopComponent.statusLabel.text")); // NOI18N
...
private void runJPQLButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_runJPQLButtonActionPerformed
    ...
    if(jpqlEditor.getText().trim().equals("")) {
        switchToResultView();
        setStatus(NbBundle.getMessage(JPQLExternalEditorTopComponent.class, "emptyQuery"));
        return;
    }
    if (puComboBox.getSelectedItem() == null) {
        logger.info("hibernate configuration combo box is empty.");
        switchToResultView();
        setStatus(NbBundle.getMessage(JPQLExternalEditorTopComponent.class, "emptyConfiguration"));
        return;
    }
    runJPQLButton.setEnabled(false);                                            
    try {
        ph = ProgressHandleFactory.createHandle(//GEN-HEADEREND:event_runJPQLButtonActionPerformed
                NbBundle.getMessage(JPQLExternalEditorTopComponent.class, "progressTaskname"));//GEN-LAST:event_runJPQLButtonActionPerformed
