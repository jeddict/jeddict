...
import org.netbeans.jpa.modeler.external.jpqleditor.CustomJPQLResult;
import org.netbeans.jpa.modeler.external.jpqleditor.JPQLExternalEditorTopComponent;
import java.net.URL;
...
//                        jpqlResult.setQueryProblems(sb.toString());
    ...
    public String execute(String query) {
        editorTopComponent = new JPQLEditorPanel(this);
        PUDataObject pud;
        try {
