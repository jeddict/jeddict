 ...
 * @author Gaurav_Gupta
 */
public class UOTORelationFlowWidget extends OTORelationFlowWidget implements UnidirectionalRelation {

    private EntityWidget targetEntityWidget;

    public UOTORelationFlowWidget(JPAModelerScene scene, EdgeWidgetInfo edge) {
        super(scene, edge);
    }
