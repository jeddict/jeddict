 ...
 * @author Gaurav_Gupta
 */
public class UMTOAssociationFlowWidget extends MTOAssociationFlowWidget implements UnidirectionalAssociation {

    private BeanClassWidget targetClassWidget;

    public UMTOAssociationFlowWidget(JPAModelerScene scene, EdgeWidgetInfo edge) {
        super(scene, edge);
    }
