 ...
 * @author Gaurav Gupta
 */
public abstract class OTMAssociationFlowWidget extends HierarchicalAssociationFlowWidget {
    ...
    public OTMAssociationFlowWidget(JPAModelerScene scene, EdgeWidgetInfo edge) {
        super(scene, edge);
