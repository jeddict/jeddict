...
public class ResultSetMappingsPanel extends EntityComponent<SqlResultSetMapping> {
    ...
    private final io.github.jeddict.jpa.spec.Entity entity; // entity null if used from other setting such as stored procedure or named queries
    ...
    public ResultSetMappingsPanel(ModelerFile modelerFile, io.github.jeddict.jpa.spec.Entity entity) {
        this.modelerFile = modelerFile;
        this.entityMappings = (EntityMappings) modelerFile.getModelerScene().getBaseElementSpec();
        this.entity = entity;
    }
