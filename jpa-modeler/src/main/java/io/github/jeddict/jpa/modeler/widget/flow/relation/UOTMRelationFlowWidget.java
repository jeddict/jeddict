 ...
 * @author Gaurav_Gupta
 */
public class UOTMRelationFlowWidget extends OTMRelationFlowWidget implements UnidirectionalRelation {

    private EntityWidget targetEntityWidget;

    public UOTMRelationFlowWidget(JPAModelerScene scene, EdgeWidgetInfo edge) {
        super(scene, edge);
    }
