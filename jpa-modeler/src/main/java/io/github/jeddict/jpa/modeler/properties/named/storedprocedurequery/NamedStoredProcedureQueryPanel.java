...
public class NamedStoredProcedureQueryPanel extends EntityComponent<NamedStoredProcedureQuery> implements DocumentListener {
    ...
    private void loadResultClassesList() {
        ...
        for (String resultClass : namedStoredProcedureQuery.getResultClass()) {
            if (resultClass.charAt(0) == '{' && resultClass.charAt(resultClass.length() - 1) == '}') {
                ...
                io.github.jeddict.jpa.spec.Entity entity = entityMappings.getEntity(id);
                if (entity != null) {
    ...
    private void initResultClassesModel() {
        ...
        for (io.github.jeddict.jpa.spec.Entity entity : entityMappings.getEntity()) {
    ...
    private void initComponents() {
        ...
        procedureName_LayeredPane.setPreferredSize(new java.awt.Dimension(170, 27));
        procedureName_LayeredPane.setLayout(new java.awt.BorderLayout());
        ...
        procedureName_LayeredPane.add(procedureName_Label, java.awt.BorderLayout.WEST);
        ...
        procedureName_LayeredPane.add(procedureName_jComboBox, java.awt.BorderLayout.CENTER);
        ...
        dbCon_Label.setPreferredSize(new java.awt.Dimension(90, 14));
        ...
        parameters_LayeredPaneLayout.setHorizontalGroup(
            ...
            .addComponent(parametersEditor, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        );
        parameters_LayeredPaneLayout.setVerticalGroup(
            parameters_LayeredPaneLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(parameters_LayeredPaneLayout.createSequentialGroup()
                .addComponent(parametersEditor, javax.swing.GroupLayout.DEFAULT_SIZE, 285, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        base_jLayeredPaneLayout.setHorizontalGroup(
            ...
            .addGroup(base_jLayeredPaneLayout.createSequentialGroup()
                ...
                .addGroup(base_jLayeredPaneLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(procedureName_LayeredPane, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        base_jLayeredPaneLayout.setVerticalGroup(
            ...
            .addGroup(base_jLayeredPaneLayout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(parameters_LayeredPane, javax.swing.GroupLayout.DEFAULT_SIZE, 287, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        resultClasses_Action.setIcon(new javax.swing.ImageIcon(getClass().getResource("/io/github/jeddict/jpa/modeler/properties/resource/searchbutton.png"))); // NOI18N
        ...
        queryHint_LayeredPaneLayout.setHorizontalGroup(
            ...
            .addComponent(queryHintEditor, javax.swing.GroupLayout.DEFAULT_SIZE, 808, Short.MAX_VALUE)
        );
        ...
        action_jLayeredPaneLayout.setHorizontalGroup(
            ...
            .addGroup(action_jLayeredPaneLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(cancel_Button, javax.swing.GroupLayout.PREFERRED_SIZE, 75, Short.MAX_VALUE)
                .addContainerGap())
        );
        action_jLayeredPaneLayout.setVerticalGroup(
            action_jLayeredPaneLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(action_jLayeredPaneLayout.createSequentialGroup()
                .addGroup(action_jLayeredPaneLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
        ...
        root_jLayeredPaneLayout.setHorizontalGroup(
            ...
            .addComponent(jTabbedPane, javax.swing.GroupLayout.PREFERRED_SIZE, 703, Short.MAX_VALUE)
...
//
        ...
        if ("Result Classes".equals(resultSetMappingType_jComboBox.getSelectedItem())) {
            ...
            for (Object obj : resultClasses_jList.getSelectedValuesList()) {
                if (obj instanceof io.github.jeddict.jpa.spec.Entity) {
                    io.github.jeddict.jpa.spec.Entity entityObj = (io.github.jeddict.jpa.spec.Entity) obj;
                    namedStoredProcedureQuery.addResultClass(entityObj);
                } else {
...
//            LOG.log(Level.WARNING, null, ble);
    ...
    private NAttributeEntity getResultSetMappings() {
        ...
        columns.add(new Column("ENTITY_OBJECT", false, true, io.github.jeddict.jpa.spec.Entity.class));
...
//                }
            ...
            public void setData(List<Object[]> data) {
                ...
                for (Object[] row : data) {
                    ...
                    io.github.jeddict.jpa.spec.Entity entity = (io.github.jeddict.jpa.spec.Entity) row[1];
    ...
    private class ResultClassesRenderer extends JLabel implements ListCellRenderer {
        ...
        public Component getListCellRendererComponent(JList list, Object object, int index,
            ...
            if (object instanceof io.github.jeddict.jpa.spec.Entity) {
                io.github.jeddict.jpa.spec.Entity entity = (io.github.jeddict.jpa.spec.Entity) object;
