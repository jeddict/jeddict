 ...
 * @author Gaurav_Gupta
 */
public class UOTOAssociationFlowWidget extends OTOAssociationFlowWidget implements UnidirectionalAssociation {

    private BeanClassWidget targetClassWidget;

    public UOTOAssociationFlowWidget(JPAModelerScene scene, EdgeWidgetInfo edge) {
        super(scene, edge);
    }
    ...
    public void setTargetClassWidget(BeanClassWidget targetJavaClass) {
        this.targetClassWidget = targetJavaClass;
