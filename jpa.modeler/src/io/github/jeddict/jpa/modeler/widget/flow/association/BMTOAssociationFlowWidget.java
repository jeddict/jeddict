 ...
 * @author Gaurav_Gupta
 */
public class BMTOAssociationFlowWidget extends MTOAssociationFlowWidget implements BidirectionalAssociation {

    private AssociationAttributeWidget targetAssociationAttributeWidget;

    public BMTOAssociationFlowWidget(JPAModelerScene scene, EdgeWidgetInfo edge) {
        super(scene, edge);
    }
