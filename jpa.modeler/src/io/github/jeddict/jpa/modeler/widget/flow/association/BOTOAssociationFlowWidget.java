 ...
 * @author Gaurav_Gupta
 */
public class BOTOAssociationFlowWidget extends OTOAssociationFlowWidget implements BidirectionalAssociation {

    private AssociationAttributeWidget targetAssociationAttributeWidget;

    public BOTOAssociationFlowWidget(JPAModelerScene scene, EdgeWidgetInfo edge) {
        super(scene, edge);
    }
