...
import static io.github.jeddict.jpa.modeler.initializer.JPAModelerUtil.MTOR_SOURCE_ANCHOR_SHAPE;
import static io.github.jeddict.jpa.modeler.initializer.JPAModelerUtil.MTOR_TARGET_ANCHOR_SHAPE;
 ...
 * @author Gaurav Gupta
 */
public abstract class MTOAssociationFlowWidget extends HierarchicalAssociationFlowWidget {
    ...
    public MTOAssociationFlowWidget(JPAModelerScene scene, EdgeWidgetInfo edge) {
        super(scene, edge);
