...
import static io.github.jeddict.jcode.jsonb.JSONBConstants.JSONB_TYPE_DESERIALIZER;
...
public class TypeDeserializerSnippet implements Snippet {
    ...
    public String getSnippet() throws InvalidDataException {
        ...
        builder.append("@").append(JSONB_TYPE_DESERIALIZER);
    ...
    public Collection<String> getImportSnippets() throws InvalidDataException {
        ...
        importSnippets.add(JSONB_TYPE_DESERIALIZER_FQN);
