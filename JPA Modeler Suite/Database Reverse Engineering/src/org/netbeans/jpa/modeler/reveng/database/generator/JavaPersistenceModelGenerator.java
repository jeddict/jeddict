...
//        }
    ...
    private static final class Generator {
        ...
        public void runImpl() throws IOException {
            ...
            entityMappingsSpec.setDBImportGenerated();
...
//                entitySpecMap.put(entityClassName, entitySpec);
            ...
            for (org.netbeans.jpa.modeler.spec.Entity entity : entityMappingsSpec.getEntity()) {
                for (ManyToMany manyToMany : entity.getAttributes().getManyToMany()) {
                    if (manyToMany.getMappedBy() != null) {
                        manageSiblingAttribute(entityMappingsSpec, entity, manyToMany);
                    }
                }
                for (OneToMany oneToMany : entity.getAttributes().getOneToMany()) {
                    if (oneToMany.getMappedBy() != null) {
                        manageSiblingAttribute(entityMappingsSpec, entity, oneToMany);
                    }
                }
                for (OneToOne oneToOne : entity.getAttributes().getOneToOne()) {
                    if (oneToOne.getMappedBy() != null) {
                        manageSiblingAttribute(entityMappingsSpec, entity, oneToOne);
                    }
                }
            }
        ...
        void manageSiblingAttribute(org.netbeans.jpa.modeler.spec.EntityMappings entityMappings, org.netbeans.jpa.modeler.spec.Entity targetEntity, RelationAttribute relationAttribute_Owner) {
            org.netbeans.jpa.modeler.spec.Entity sourceEntity = entityMappings.findEntity(relationAttribute_Owner.getTargetEntity());
