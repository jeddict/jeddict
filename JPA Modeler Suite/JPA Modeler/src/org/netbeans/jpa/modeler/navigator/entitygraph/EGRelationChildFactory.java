...
public class EGRelationChildFactory extends EGChildFactory {

    private EntityWidget entityWidget;
    private RelationAttributeWidget initialAttributeWidget;

    public EGRelationChildFactory(EntityWidget parentEntityWidget, RelationAttributeWidget initialAttributeWidget, EntityWidget entityWidget) {
        super(parentEntityWidget);
