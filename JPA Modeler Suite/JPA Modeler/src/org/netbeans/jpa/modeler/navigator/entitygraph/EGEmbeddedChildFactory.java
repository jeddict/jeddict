...
public class EGEmbeddedChildFactory extends EGChildFactory {

    private EmbeddableWidget embeddableWidget;
    private EmbeddedAttributeWidget initialAttributeWidget;

    public EGEmbeddedChildFactory(EntityWidget entityWidget, EmbeddedAttributeWidget initialAttributeWidget, EmbeddableWidget embeddableWidget) {
        super(entityWidget);
