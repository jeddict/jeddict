 ...
 * @author Gaurav Gupta
 */
public class MTORelationFlowWidget extends HierarchicalRelationFlowWidget {

    public MTORelationFlowWidget(IModelerScene scene, EdgeWidgetInfo edge) {
        super(scene, edge);
        setSourceAnchorShape(AnchorShapeFactory.createImageAnchorShape(ImageUtilities.loadImage("org/netbeans/jpa/modeler/resource/image/many-to-one.gif"), true));
