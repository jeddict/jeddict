 ...
 * @author Gaurav_Gupta
 */
public class UMTORelationFlowWidget extends MTORelationFlowWidget implements Unidirectional {

    private EntityWidget targetEntityWidget;

    public UMTORelationFlowWidget(IModelerScene scene, EdgeWidgetInfo edge) {
        super(scene, edge);
    }
