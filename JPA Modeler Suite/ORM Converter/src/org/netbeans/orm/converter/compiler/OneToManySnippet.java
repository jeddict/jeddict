...
public class OneToManySnippet extends AbstractRelationDefSnippet
    ...
    public List<String> getImportSnippets() throws InvalidDataException {
        ...
        if (getFetchType() == null
            ...
            return Collections.singletonList("javax.persistence.OneToMany");
        }

        List<String> importSnippets = new ArrayList<String>();

        importSnippets.add("javax.persistence.OneToMany");
