...
public class JavaSourceParserUtil {
     ...
     * @return The project encoding, or a suitable default if the project
     * encoding cannot be determined. Never null
     */
    ...
    /**
     * Get the encoding of the supplied project as a String (by performing a
     * lookup and invoking Charset.name).
     *
     * @param project The project
     * @param file A file in the project
     * @return The project encoding, or a suitable default if the project
