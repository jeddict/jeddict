...
public class Basic extends PersistenceBaseAttribute implements AccessTypeHandler, FetchTypeHandler {
    ...
    public static Basic load(Element element, VariableElement variableElement) {
        AnnotationMirror annotationMirror = JavaSourceParserUtil.findAnnotation(element, "javax.persistence.Basic");
        Basic basic = new Basic();
        basic.column = Column.load(element, variableElement);
        ...
        basic.access = AccessType.load(element, variableElement);
