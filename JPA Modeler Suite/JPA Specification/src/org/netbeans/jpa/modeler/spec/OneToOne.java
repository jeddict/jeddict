...
public class OneToOne extends RelationAttribute implements JoinColumnHandler {
    ...
    public static OneToOne load(Element element, VariableElement variableElement) {
        ...
        oneToOne.targetEntity = (String) JavaSourceParserUtil.findAnnotationValue(annotationMirror, "targetEntity");
        ...
        oneToOne.access = AccessType.load(element, variableElement);
