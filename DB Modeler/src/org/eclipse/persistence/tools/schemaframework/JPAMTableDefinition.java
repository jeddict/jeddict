...
public class JPAMTableDefinition extends TableDefinition {
    ...
    public void buildDBTable(AbstractSession session, DBMapping dbMapping) throws ValidationException {
        ...
        if (attribute instanceof RelationAttribute) {
            table = new DBRelationTable(getFullName(), (Entity) intrinsicEntity.get(0), (RelationAttribute) attribute);//Todo pass managedClass
        } else if (attribute instanceof ElementCollection) {
            table = new DBCollectionTable(getFullName(), (Entity) intrinsicEntity.get(0), (ElementCollection) attribute);
        } else {
            table = new DBBaseTable(getFullName(), (Entity) intrinsicEntity.get(0));
        }
