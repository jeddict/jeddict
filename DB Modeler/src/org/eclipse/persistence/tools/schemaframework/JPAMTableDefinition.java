...
public class JPAMTableDefinition extends TableDefinition {
    ...
    private final Entity intrinsicEntity;
    private final Attribute attribute;

    public JPAMTableDefinition(ManagedClass managedClass, Attribute attribute, Entity intrinsicEntity) {
        super();
        this.managedClass = managedClass;
        this.intrinsicEntity = intrinsicEntity;
    ...
    public void buildDBTable(AbstractSession session, DBMapping dbMapping) throws ValidationException {
        ...
        if (attribute instanceof RelationAttribute) {
            table = new DBRelationTable(getFullName(), intrinsicEntity, (RelationAttribute) attribute);//Todo pass managedClass
        } else if (attribute instanceof ElementCollection) {
            table = new DBCollectionTable(getFullName(), intrinsicEntity, (ElementCollection) attribute);
        } else {
            table = new DBBaseTable(getFullName(), intrinsicEntity);
        }
...
//     */
//    public void addField(Attribute attribute, Attribute refAttribute, String fieldName, Class type) {
//        this.addField(new JPAMFieldDefinition(attribute, refAttribute, fieldName, type));
//    }
//
//    /**
...
//     * @param type is the Java class type corresponding to the database type.
//     */
//    public void addField(Attribute attribute, Attribute refAttribute, String fieldName, Class type, int fieldSize) {
//        this.addField(new JPAMFieldDefinition(attribute, refAttribute, fieldName, type, fieldSize));
//    }
//
//    /**
//     * PUBLIC: Add the field to the table.
...
//     * @param type is the Java class type corresponding to the database type.
//     */
//    public void addField(Attribute attribute, Attribute refAttribute, String fieldName, Class type, int fieldSize, int fieldSubSize) {
//        this.addField(new JPAMFieldDefinition(attribute, refAttribute, fieldName, type, fieldSize, fieldSubSize));
//    }
//
//    /**
...
//     */
//    public void addField(Attribute attribute, Attribute refAttribute, String fieldName, String typeName) {
//        addField(new JPAMFieldDefinition(attribute, refAttribute, fieldName, typeName));
//    }
//    /**
//     * PUBLIC: Add the field to the table.
//     */
...
//     * @param type is the Java class type corresponding to the database type.
//     */
//    public void addIdentityField(Attribute attribute, Attribute refAttribute, String fieldName, Class type) {
//        FieldDefinition fieldDef = new JPAMFieldDefinition(attribute, refAttribute, fieldName, type);
...
//     * @param type is the Java class type corresponding to the database type.
//     */
//    public void addIdentityField(Attribute attribute, Attribute refAttribute, String fieldName, Class type, int fieldSize) {
//        FieldDefinition fieldDef = new JPAMFieldDefinition(attribute, refAttribute, fieldName, type, fieldSize);
//        fieldDef.setIsIdentity(true);
//        fieldDef.setIsPrimaryKey(true);
//        addField(fieldDef);
//    }
...
//     * @param type is the Java class type corresponding to the database type.
//     */
//    public void addPrimaryKeyField(Attribute attribute, Attribute refAttribute, String fieldName, Class type) {
//        FieldDefinition fieldDef = new JPAMFieldDefinition(attribute, refAttribute, fieldName, type);
//        fieldDef.setIsPrimaryKey(true);
//        addField(fieldDef);
//    }
...
//     * @param type is the Java class type corresponding to the database type.
//     */
//    public void addPrimaryKeyField(Attribute attribute, Attribute refAttribute, String fieldName, Class type, int fieldSize) {
//        FieldDefinition fieldDef = new JPAMFieldDefinition(attribute, refAttribute, fieldName, type, fieldSize);
//        fieldDef.setIsPrimaryKey(true);
//        addField(fieldDef);
//    }
