...
public class JPAMTableDefinition extends TableDefinition {
    ...
    private final Queue<Entity> intrinsicEntity = new LinkedList<>();
    private final Attribute attribute;

    public JPAMTableDefinition(ManagedClass managedClass, Attribute managedAttribute, Queue<Entity> intrinsicEntity) {
    ...
    public void buildDBTable(AbstractSession session, DBMapping dbMapping) throws ValidationException {
        ...
        if (attribute instanceof RelationAttribute) {
            table = new DBRelationTable(getFullName(), (Entity)managedClass, (RelationAttribute) attribute);//Todo pass managedClass
        } else if (attribute instanceof ElementCollection) {
            table = new DBCollectionTable(getFullName(), (Entity)managedClass, (ElementCollection) attribute);
        } else {
            table = new DBBaseTable(getFullName(), (Entity)managedClass);
        }
