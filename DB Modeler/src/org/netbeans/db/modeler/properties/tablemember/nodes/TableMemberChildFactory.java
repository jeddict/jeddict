...
//        Attribute attribute = (Attribute) columnWidget.getBaseElementSpec();
        ...
        childNode = new TMLeafNode(columnWidget, parentNode.getBaseElementSpec(), Children.LEAF, checkableNode);
