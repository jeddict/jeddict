...
//        assert persistenceGen != null;
    ...
    /**
     * Sets the new table closure and target folder at once. This is needed in
     * order to avoid multiple validations in the table closure and the target
    ...
    /**
     * Sets the new table closure, returning true if the new table closure was
     * different than the current value and false otherwise.
     */
...
//            table2UpdateType.clear();
    ...
    /**
     * Sets the new target folder, returning true if the new target folder was
     * different from the current value and false otherwise.
     */
    ...
    /**
     * Adds a new change listener, which will be called when the list of
     * selected tables changes, when a class name for a table changes or when
     * the return value of {@link #getFirstProblemDisplayName} changes.
     */
    ...
    /**
     * Returns a sorted list of selected tables. This returns the same tables as
...
//    }
    ...
    /**
     * Returns the display name of the first problem regarding a table or its
     * class name (the class name may be an invalid Java identifier or a JPA QL
     * reserved keyword, or the class might exist in the target folder.
     */
