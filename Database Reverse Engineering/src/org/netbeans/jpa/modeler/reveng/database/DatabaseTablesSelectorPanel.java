...
public class DatabaseTablesSelectorPanel extends javax.swing.JPanel implements AncestorListener {
    ...
    public DatabaseTablesSelectorPanel() {
        initComponents();
        initInitial();
            ...
            public void stateChanged(ChangeEvent e) {
                if (project != null && ProviderUtil.isValidServerInstanceOrNone(project)) {
                    ...
                    if (!Util.isContainerManaged(project)) {
                        ...
                        DialogDisplayer.getDefault().notify(new NotifyDescriptor.Message(NbBundle.getMessage(DatabaseTablesSelectorPanel.class, "WRN_Server_Does_Not_Support_DS")));
                    } else {
    ...
    private void initInitial() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(datasourceLabel, org.openide.util.NbBundle.getMessage(DatabaseTablesSelectorPanel.class, "LBL_Wait"));
    }

    private void initializeWithDatasources() {
        org.openide.awt.Mnemonics.setLocalizedText(datasourceRadioButton, org.openide.util.NbBundle.getMessage(DatabaseTablesSelectorPanel.class, "LBL_Datasource"));
        org.openide.awt.Mnemonics.setLocalizedText(datasourceLabel, org.openide.util.NbBundle.getMessage(DatabaseTablesSelectorPanel.class, "LBL_Datasource"));
    ...
    private void initializeWithDbConnections() {
        org.openide.awt.Mnemonics.setLocalizedText(datasourceRadioButton, org.openide.util.NbBundle.getMessage(DatabaseTablesSelectorPanel.class, "LBL_JDBCConnection"));
        org.openide.awt.Mnemonics.setLocalizedText(datasourceLabel, org.openide.util.NbBundle.getMessage(DatabaseTablesSelectorPanel.class, "LBL_JDBCConnection"));
    ...
    /**
     * Finds the database connections whose database URL and user name equal the
     * database URL and the user name of the passed data source.
     *
        ...
        if (datasourceRadioButton.isSelected()) {
            ...
            if (jpaDS != null) {
                ...
                if (dbconns.size() > 0) {
                    ...
                    if (drvClass == null) {
                        notify(NbBundle.getMessage(DatabaseTablesSelectorPanel.class, "ERR_NoDriverClassName"));
                    } else {
                        JDBCDriver[] drivers = JDBCDriverManager.getDefault().getDrivers(drvClass);
                        if (drivers.length == 0) {
                            notify(NbBundle.getMessage(DatabaseTablesSelectorPanel.class, "ERR_NoDriverError", drvClass));
                        } else {
                ...
                if (dbconn != null) {
                    try {
                        ...
                        notify(NbBundle.getMessage(DatabaseTablesSelectorPanel.class, "ERR_DatabaseError"));
                    }
                }
            ...
            if (t.isDisabled()) {
                if (t.getDisabledReason() instanceof Table.ExistingDisabledReason) {
                    ...
                    if (allowUpdateRecreate) {
                        problems += (problems.length() > 0 ? "\n" : "") + NbBundle.getMessage(DatabaseTablesSelectorPanel.class, "MSG_Already_Mapped_UpdateAllowed", new Object[]{t.getName(), existingClass});
                    } else {
                        problems += (problems.length() > 0 ? "\n" : "") + NbBundle.getMessage(DatabaseTablesSelectorPanel.class, "MSG_Already_Mapped_UpdateAllowed", new Object[]{t.getName(), existingClass});
                    }
                    ...
                    problems += (problems.length() > 0 ? "\n" : "") + NbBundle.getMessage(DatabaseTablesSelectorPanel.class, "MSG_Already_Mapped_NotInSource", new Object[]{t.getName(), existingClass});
                } else if (t.getDisabledReason() instanceof Table.NoPrimaryKeyDisabledReason) {
                    problems += (problems.length() > 0 ? "\n" : "") + NbBundle.getMessage(DatabaseTablesSelectorPanel.class, "MSG_No_Primary_Key", new Object[]{t.getName()});
                }
            }
        }
    ...
    private void initComponents() {
        ...
        setName(org.openide.util.NbBundle.getMessage(DatabaseTablesSelectorPanel.class, "LBL_DatabaseTables")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(datasourceLabel, org.openide.util.NbBundle.getMessage(DatabaseTablesSelectorPanel.class, "LBL_Datasource")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(datasourceRadioButton, org.openide.util.NbBundle.getMessage(DatabaseTablesSelectorPanel.class, "LBL_Datasource")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(dbschemaRadioButton, org.openide.util.NbBundle.getMessage(DatabaseTablesSelectorPanel.class, "LBL_DbSchema")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(availableTablesLabel, org.openide.util.NbBundle.getMessage(DatabaseTablesSelectorPanel.class, "LBL_AvailableTables")); // NOI18N
        availableTablesLabel.setToolTipText(org.openide.util.NbBundle.getMessage(DatabaseTablesSelectorPanel.class, "TXT_AvailableTables")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        ...
        availableTablesList.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(DatabaseTablesSelectorPanel.class, "ACSN_AvailableTables")); // NOI18N
        availableTablesList.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(DatabaseTablesSelectorPanel.class, "ACSD_AvailableTables")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(selectedTablesLabel, org.openide.util.NbBundle.getMessage(DatabaseTablesSelectorPanel.class, "LBL_SelectedTables")); // NOI18N
        selectedTablesLabel.setToolTipText(org.openide.util.NbBundle.getMessage(DatabaseTablesSelectorPanel.class, "TXT_SelectedTables")); // NOI18N
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 2;
        gridBagConstraints.gridy = 0;
        gridBagConstraints.anchor = java.awt.GridBagConstraints.NORTHWEST;
        ...
        selectedTablesList.getAccessibleContext().setAccessibleName(org.openide.util.NbBundle.getMessage(DatabaseTablesSelectorPanel.class, "ACSN_SelectedTables")); // NOI18N
        selectedTablesList.getAccessibleContext().setAccessibleDescription(org.openide.util.NbBundle.getMessage(DatabaseTablesSelectorPanel.class, "ACSD_SelectedTables")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(addButton, org.openide.util.NbBundle.getMessage(DatabaseTablesSelectorPanel.class, "LBL_Add")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(removeButton, org.openide.util.NbBundle.getMessage(DatabaseTablesSelectorPanel.class, "LBL_Remove")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(addAllButton, org.openide.util.NbBundle.getMessage(DatabaseTablesSelectorPanel.class, "LBL_AddAll")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(removeAllButton, org.openide.util.NbBundle.getMessage(DatabaseTablesSelectorPanel.class, "LBL_RemoveAll")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(tableClosureCheckBox, org.openide.util.NbBundle.getMessage(DatabaseTablesSelectorPanel.class, "LBL_IncludeRelatedTables")); // NOI18N
        tableClosureCheckBox.setToolTipText(org.openide.util.NbBundle.getMessage(DatabaseTablesSelectorPanel.class, "TXT_IncludeRelatedTables")); // NOI18N
    ...
    public static final class WizardPanel implements WizardDescriptor.Panel<WizardDescriptor>, ChangeListener {
        ...
        private DatabaseTablesSelectorPanel component;
        ...
        @Override
        public DatabaseTablesSelectorPanel getComponent() {
            if (component == null) {
                component = new DatabaseTablesSelectorPanel();
